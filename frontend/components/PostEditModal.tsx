        ...
        <div className="px-5 pt-4">
          ...
          <div className="flex items-center gap-2 mt-1.5 mb-4">
            <button
              ...
              className="text-xs text-[#1c69d4] font-semibold hover:text-[#0653b6] disabled:opacity-40 transition-colors">
          ...
          <div className="mb-4 pt-3 border-t border-[#f7f7f7]">
            ...
            <div className="flex items-center gap-2 mt-1.5">
              <button
                ...
                className="px-3 py-1.5 text-xs font-semibold bg-[#1c69d4] text-white hover:bg-[#0653b6] rounded disabled:opacity-40 transition-colors">
          ...
          <div className="pb-4 border-t border-[#f7f7f7] pt-3">
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="text-xs border border-[#e6e6e6] px-2 py-1.5 focus:outline-none focus:border-[#1c69d4] bg-white rounded"
              />
              <button
                onClick={saveDate}
