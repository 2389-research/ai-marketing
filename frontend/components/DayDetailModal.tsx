  ...
  return (
    <div className="px-5 py-4">
      ...
      <div className="flex items-center gap-2.5 mb-2 flex-wrap">
        ...
        <button
          onClick={onOpen}
          className="ml-auto text-xs font-semibold text-[#1c69d4] hover:text-[#0653b6] transition-colors shrink-0">
          Open →
        </button>
      </div>
      ...
      {long && (
        <button
          ...
          className="text-xs text-[#1c69d4] hover:text-[#0653b6] font-medium mt-1 transition-colors">
        ...
        <div className="flex items-center justify-between px-5 pt-4 pb-3 border-b border-[#f7f7f7] shrink-0">
          ...
          <div className="flex items-center gap-4">
            {onCreate && (
              <button
                onClick={onCreate}
                className="text-xs font-semibold text-[#1c69d4] hover:text-[#0653b6] transition-colors">
                + New post
              </button>
            )}
